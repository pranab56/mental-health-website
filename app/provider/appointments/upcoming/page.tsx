  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-slate-800 tracking-tight">Upcoming Appointments</h1>
          <p className="text-slate-500 text-sm">You have {filteredAppointments.length} sessions scheduled for today.</p>
        </div>
        ...
        <div className="relative w-full md:w-80">
          ...
          <Input
            ...
            className="pl-10 h-11 bg-white border-slate-200 rounded-xl focus-visible:ring-[#9785BA]/20 focus-visible:border-[#9785BA]"
          />
        </div>
      </div>
                ...
                <CardContent className="p-4 md:p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="flex items-center gap-5 w-full md:w-auto">
                    <Avatar className="h-16 w-16 border-2 border-white shadow-sm shrink-0">
                      ...
                      <AvatarFallback className="bg-[#9785BA]/10 text-[#9785BA] font-semibold">
                        {appointment.clientName.split(' ').map(n => n[0]).join('')}
                      </AvatarFallback>
                    </Avatar>

                    <div className="space-y-1">
                      <h3 className="font-semibold text-slate-800 text-lg leading-tight group-hover:text-[#9785BA] transition-colors">
                  ...
                  <Button
                    ...
                    className="w-full md:w-auto bg-[#9785BA] hover:bg-[#8674A9] text-white px-8 h-12 rounded-xl flex items-center gap-3 shadow-lg shadow-[#9785BA]/15 transition-all duration-300 transform active:scale-95 cursor-pointer"
                  >
